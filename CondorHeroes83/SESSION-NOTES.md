...
- **Ep1 single-firings:**
  ...
  - **顏烈 / 阿鰲 (完顏洪烈's disguise alias)** (Ep1 sub 344) — first on-screen cover identity before the 楊康 adoption arc. Will need renderings settled if the alias recurs (probably not; once 包惜弱 reaches the 金 palace, he reveals his real identity).
  ...
  - **道長 / 真人 / 貧道 / 道爺 / 道士 (Taoist address cluster)** (Ep1 throughout 丘處機 scenes) — promoted to Ep1 overlay. Will recur in every 全真教 / 馬鈺 / 王重陽 / 丘處機 scene across the series. **Two-episode confirmation candidate** — likely Ep2 will fire all five again (江南七怪 wager); **promote to `extras_baseline.json`** after Ep2 confirms.
  - **大俠 (general honorific)** (Ep1 sub 125) — "great hero". Will recur. Single-firing; baseline-promotion candidate.
  ...
  - **希彰 / 希芯 → 希望 chi-OCR** (Ep1 subs 321, 322) — continuing the Ep33 sub 50 pattern (希彰→希望). Two-firing across bundle versions — **promote to `cjk_fix_v2.py` `OCR_NAME_COLLAPSE` on next firing** of either variant.
