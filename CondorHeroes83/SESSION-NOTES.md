...
| 19 | v18 | 419 | 楊鐵心/包惜弱 双双殉情 (滿江紅 quatrain reprise from Ep1+Ep17) + 楊康 final break with 念慈 + 完顏洪烈 declares 楊康 大金國 heir + 郭靖/楊康 白石灘 duel pact + 丘道長 transmits 全真教 內功心法 (鉛汞 meditation formulas) + 蓉兒 軟蝟甲 poison-trick refused + 楊康 takes 郭靖's blade in 完顏洪烈's place + 穆姑娘 vanishes + 蓉兒/全真教 confrontation + 郭靖 入道儀式 narrowly avoided + 元好問 摸魚兒 問世間情為何物 closer. First FULL firing for: 楊大嬸 (王府 generation address; Ep18 OCR-flagged 楊大姥→楊大嬸 confirmed cleanly here), 穆姊姊 (蓉兒's address to 穆念慈), 華箏公主 (formal title), 白石灘 (郭靖/楊康 duel venue), 柯大俠 (vocative for 柯鎮惡), 大俠 (bare). Cross-episode: 滿江紅 quatrain Ep1+Ep17+Ep19 three-ep — STYLE §10 entry confirmed stable; 鉛汞 meditation formulas (鉛體沉墜/汞性流動 family) — first 全真教 內功 transmission rendered as §10 CJK+gloss couplets per existing meditation/qi precedent; 元好問 摸魚兒 「問世間, 情為何物」 line — first firing as full classical 詞 quotation, CJK+gloss; 認賊作父 Ep5+Ep17+Ep19 three-ep stable; 楊大嫂 Ep17+Ep19 two-ep → baseline; 念慈/穆姑娘/楊康/阿康/康兒 cross-arc continued; 大金國 cross-stage trap Ep11+14+17+19 firing cleanly via cjk_fix_v2; 軟蝟甲 Ep10+15+16+19 four-ep stable; 完顏洪烈 cross-stage `六Your Highness`/`六王爺` trap firing cleanly. Chi-OCR: 楊大姥→楊大嫂 (Ep18+Ep19 two-ep — promote OCR_NAME_COLLAPSE); 网康→阿康 (Ep24+Ep19 two-ep — promote OCR_NAME_COLLAPSE; 网/阿 chi novel drift); 完顏洪鰲→完顏洪烈 (sub 110 single-firing chi novel); 量有此理→豈有此理 (continuing collapse-table firing); 鞭兒/其兒→蓉兒 (continuing batch); 郭蜻→郭靖 (continuing batch); 養痛之恩→養育之恩 (sub 8 chi-OCR; yue clean); 侈→爹 (sub 43 — Ep23+Ep16+Ep18+Ep19 four-ep, urgent OCR_NAME_COLLAPSE promotion); 蔡→替 (sub 280 chi novel single-firing); 葵古→蒙古 (sub 197 — same Ep20-batch family); 患上昧→愚昧 (sub 357 chi dittography); 跪計→鬼計 (sub 209 chi 跪/鬼 visual drift). Promotion flags: 道長 bare as standalone Taoist address — added to overlay this ep, **promote to extras_baseline.json** (recurs every 全真教 / 丘道長 / 馬道長 / 王道長 scene; was in build.py titles? check audit); 江南 bare → **promote baseline** (Gong-naam / Gong-naahm — already in STYLE §8 with romanisation but not in baseline; surfaced here in 江南七怪 reference); 楊大嫂 → baseline (two-ep with Ep17+Ep19); 柯大俠/大俠 → baseline (Ep15 柯大俠/韓女俠 first firing + Ep19 — two-ep validated); 穆姊姊 → STYLE §5 second firing (extends 穆姑娘 family); 滿江紅 quatrain → STYLE §10 stable entry already promoted Ep17 — Ep19 confirms three-ep stability; 鉛汞 meditation formulas (鉛體沉墜/汞性流動/以給腎水・腎火/以行心水・心火/此之謂鉛汞謹收藏) → STYLE §10 meditation/qi subsection — single-firing, watch for 全真教 內功 arc recurrence; 問世間情為何物 (元好問 摸魚兒) → STYLE §10 single-firing classical 詞, watch for recurrence (likely closing/opening cards in 神鵰 sequel territory but possibly recurs in this series). |
| 20 | v13 | 587 | 臨安 / 元宵 arc with 岳文 and 武穆遺書 plot. **Per-user instruction this session: 娘→娘親 normalised throughout (STYLE §4 Cantonese-preferred; missed in Ep17). Same applies retroactively if Ep17 is re-processed; bare 爹→爹親 normalised in parallel.** First FULL firing for: 楊大嬸/大嬸 (王府-era 包惜弱 address by 楊鐵心 generation), 桃花鎮 (蓉兒's pre-桃花島 town), 醉月樓 (Lin'an inn — 丘道長 confronts 楊康), 正德 大街 (Jin/Song border road), 竇 小姐 (one-off bystander). Cross-episode: **人不風流枉少年 Ep14+Ep18 two-ep** (named 俗語; STYLE §10 admission gate passes — register cultural weight English flattens — promote on next firing); 法華寺 Ep1+Ep18 two-ep (canonical from Ep1 — promote to baseline); 牛家村 Ep14+15+18 three-ep stable (promote to baseline); 阿康/康兒/念慈/穆姑娘 cross-arc continued from Ep11–17. Chi-OCR: 楊大姥→楊大嬸 (4 subs; 姥/嬸 visual drift, yue clean — promote OCR_NAME_COLLAPSE on next firing); 希龐/希劑/希鹿/希單→希望 (continuing Ep1+2+10+33 batch — collapse table firing); 會牲/會牡→畜生 (Ep14+17+18 three-ep batch); 路下→跪下 (Ep17+Ep18 two-ep); 侈→爹 (Ep23+16+18 three-ep — promote OCR_NAME_COLLAPSE); 后飛→岳飛 (sub 216 single-firing); 哲頭→舉頭 (sub 302 chi novel OCR); 千道士→丘道士 (sub 94 chi-OCR — yue garbled, but 丘處機 identity confirmed by next-sub context); 元顏康→完顏康 (chi-OCR Ep18 novel, watch); 自做功→自作孽 (sub 233 single-firing). Promotion flags: **爹親 cross-stage trap → cjk_fix_v2 `Father親 → Father` added this session** (parallel to existing My Mother子→my wife pattern; first firing on bundle bump that introduces 爹親 normalisation rule); **歐陽公子 cross-stage trap** Ep33+Ep18 two-ep — added cjk_fix_v2 `Au-Joeng公子 → Young Master Au-Joeng` and yale `Au-Yeung公子 → Young Master Au-Yeung` this session (CSV 歐陽 stage 4 strands 公子); 大叔 bare → baseline next firing (compounds 楊大叔/穆大叔 already covered); 醉月樓 → baseline if recurs in Lin'an arcs; 卑鄙 single-firing colloquial English-only render. **Outcome: FULL.** |
...
**Ep19 single-firings (楊鐵心/包惜弱 双双殉情 + 楊康 final break + 全真教 內功 transmission + 入道儀式 averted):**
- **白石灘** — 郭靖/楊康 duel venue. Single-ep — watch for recurrence (probably one-ep only).
- **華箏公主** formal title — Watch for recurrence in Mongol-return arcs.
- **道長 (bare)** — standalone Taoist address used by 郭靖, 蓉兒, 楊鐵心 to 丘處機; rendered "Taoist". Added to Ep19 overlay; **promote to extras_baseline.json next bump** — recurs in every 全真教 / 丘道長 / 馬道長 / 王道長 scene since Ep1. Note: build.py titles dict has `丘道長 → Taoist Jau/Yau` but NOT bare 道長. The bare form is high-frequency and stable.
- **江南 (bare)** — registered to overlay as `Gong-naam / Gong-naahm`; STYLE §8 already has the romanisation. **Promote to extras_baseline.json next bump.** Surfaced here in 江南七怪 reference (sub 147, 221).
- **江南七怪** — already a STYLE §19 sed pattern; here registered to overlay for clean conversion. Promote out of the sed pattern into baseline.
- **柯大俠/大俠 (bare)** — vocative for 柯鎮惡 (sub 213, 277) and bare collective for 江南七怪 (sub 284). Ep15 柯大俠/韓女俠 first firing + Ep19 — two-ep validated. **Promote柯大俠/大俠 to extras_baseline.json next bump.**
- **穆姊姊** — 蓉兒's address to 穆念慈; STYLE §5 already has variants 穆姑娘, 穆姊姊. Two-ep with Ep18 — confirmed stable.
- **楊大嫂** — Ep17+Ep19 two-ep stable rendering "Mrs Yang"; **promote to extras_baseline.json next bump** (already aliased there as `楊夫人 → Mrs Yang`, but the 大嫂 form needs its own entry).
- **楊大嬸** — Ep18 first firing (chi-OCR 楊大姥); Ep19 sub 130 confirms canonical form. Two-ep, **promote to extras_baseline.json next bump**.
- **滿江紅 quatrain reprise** (subs 81–85, 116–118) — Ep1+Ep17+Ep19 three-ep stable. STYLE §10 entry already present (兒臣/孩兒 promotion family from Ep17). Three-ep confirms full quatrain treatment as `CJK (English gloss)` per couplet-half. Drop from Watch List — STYLE §10-stable.
- **鉛汞 meditation formulas** (subs 263–267) — first 全真教 內功 transmission rendered as `CJK (English gloss)` couplets per STYLE §10 meditation/qi precedent. Phrases: 鉛體沉墜, 以給腎水/腎火, 汞性流動, 以行心水/心火, 此之謂鉛汞謹收藏. Note the chi-OCR 給/給 in sub 263 is correctly 給 (the formula varies kidney-fire/kidney-water + heart-water/heart-fire across recitations); 263 has the misnamed pairing (kidney-fire+heart-water), 266/267 correct (kidney-water+heart-fire) as 郭靖 perfects it. Single-ep firing — watch for 周伯通 slap-memorise scene (Ep29+) where related formulas recur.
- **元好問 摸魚兒「問世間, 情為何物, 值得生死相許」** (sub 413) — first firing of this classical 詞 quotation. STYLE §10 admission gate passes (criterion 4 — poetic from identifiable literary tradition). Single-ep firing — watch for recurrence; this is the famous 元好問 line that opens 神鵰俠侶 in the sequel, likely recurs in this series too.
- **入道儀式 oath text** (subs 396–398): 我教乃是先師王重陽所創 / 心術不可得罪於天地, 言行要樹榜樣與萬民 / 一旦入教, 終身為道, 謹守教規, 死而無悔. Plain-prose oath rendering — single-ep firing — watch for 全真派 ritual recurrence.
- **「人之常情, 人各有志」family** — `人各有志` (sub 11, 楊康 to 包惜弱). Plain-prose `every man has his own ambition` — failed §10 admission gate. Watch for recurrence; if recurs, judgment-call (c) on whether 楊康's defining line warrants CJK preservation.
- **「一了百了」** (sub 386, 郭靖 contemplating 入道; sub 387 馬鈺 echoing) — plain-prose 四字成語. Failed §10 admission gate per v17 plain-prose rule. Render English-only.
- **「頂天立地」** (sub 241, 郭靖 to 蓉兒) — plain-prose ("upright man, head to Heaven and feet on Earth"). Failed §10 gate. Render English-only.
- **「忠孝仁義」** (sub 356, 蓉兒 mocking 全真教 values) — plain-prose ("loyalty and righteousness"). Failed §10 gate. Render English-only.
- **「認賊作父」** (sub 159, 楊康 self-mocking) — Ep5+Ep17+Ep19 three-ep. Hybrid uses CJK; English `calling the thief father`. Confirmed stable rendering.
- **Chi-OCR Ep19 firings**:
  - 网康→阿康 (sub 6) — Ep24+Ep19 two-ep (网/阿 chi novel drift). **Promote to OCR_NAME_COLLAPSE next bump.**
  - 楊大姥→楊大嫂 (sub 46) — Ep18+Ep19 two-ep. **Promote to OCR_NAME_COLLAPSE next bump.**
  - 養痛之恩→養育之恩 (sub 8) — chi 痛/育 visual drift; yue clean. Single-firing watch.
  - 完顏洪鰲→完顏洪烈 (sub 110) — chi 鰲/烈 novel; yue clean. Single-firing watch.
  - 跪計→鬼計 (sub 209) — chi 跪/鬼 visual drift. Single-firing watch.
  - 患上昧→愚昧 (sub 357) — chi dittography 患上/愚 + 昧. Single-firing watch.
  - 蔡→替 (sub 280) — chi 蔡/替 novel single-firing.
  - 葵古→蒙古 (sub 197) — same Ep20-batch family (chi 葵/蒙 cluster). Two-ep with Ep20 → already in collapse table.
  - 侈→爹 (sub 43) — Ep23+Ep16+Ep18+Ep19 four-ep. **Urgent OCR_NAME_COLLAPSE promotion.**
- **Concat-trap firings (handled cleanly by cjk_fix_v2 v18 tables)**: 大Jin, 六Your Highness, 我Father, 五Master, 梅Senior Sister, 楊大嫂. All resolved without intervention. Drop "六弟/二哥/七妹/三哥 sibling-ordinal" Watch entry — stable across Ep2+Ep9+Ep19 three-ep via baseline-side sibling family.
...
4. **Hold the row budget.** Target ≤1000 chars per Completed-table row body; hard cap 1150. If a row exceeds the cap, cut per-sub citations, who-said-what parentheticals, and validation summaries first.
